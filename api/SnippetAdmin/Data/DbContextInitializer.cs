...
namespace SnippetAdmin.Data
{
    public class DbContextInitializer
    {
        ...
        {
            // 元素数据
            _dbContext.RbacElements.Add(new RbacElement { Id = 1, Name = "主页", Identity = "home", Type = ElementType.Menu, AccessApi = "" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 2, Name = "RBAC管理", Identity = "rbac", Type = ElementType.Menu, AccessApi = "" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 3, Name = "关于", Identity = "about", Type = ElementType.Menu, AccessApi = "" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 7, Name = "用户信息", Identity = "user", Type = ElementType.Menu, AccessApi = "" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 9, Name = "角色信息", Identity = "role", Type = ElementType.Menu, AccessApi = "" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 10, Name = "组织信息", Identity = "org", Type = ElementType.Menu, AccessApi = "" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 11, Name = "页面权限", Identity = "permission", Type = ElementType.Menu, AccessApi = "" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 12, Name = "添加成员", Identity = "add-member", Type = ElementType.ButtonLink, AccessApi = "api/Organization/GetPositionDic,api/User/AddOrgMember" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 13, Name = "创建用户", Identity = "create-user", Type = ElementType.ButtonLink, AccessApi = "api/User/AddOrUpdateUser" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 16, Name = "编辑用户", Identity = "edit-user", Type = ElementType.ButtonLink, AccessApi = "api/User/AddOrUpdateUser" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 17, Name = "删除用户", Identity = "remove-user", Type = ElementType.ButtonLink, AccessApi = "api/User/RemoveUser" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 18, Name = "移出组织", Identity = "move-out", Type = ElementType.ButtonLink, AccessApi = "api/User/RemoveOrgMember" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 19, Name = "创建角色", Identity = "create-role", Type = ElementType.ButtonLink, AccessApi = "api/Role/AddOrUpdateRole" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 20, Name = "编辑角色", Identity = "edit-role", Type = ElementType.ButtonLink, AccessApi = "api/Role/AddOrUpdateRole" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 21, Name = "删除角色", Identity = "remove-role", Type = ElementType.ButtonLink, AccessApi = "api/Role/RemoveRole" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 22, Name = "创建组织", Identity = "create-org", Type = ElementType.ButtonLink, AccessApi = "api/Organization/CreateOrganization" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 23, Name = "编辑组织", Identity = "edit-org", Type = ElementType.ButtonLink, AccessApi = "api/Organization/UpdateOrganization" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 24, Name = "删除组织", Identity = "remove-org", Type = ElementType.ButtonLink, AccessApi = "api/Organization/DeleteOrganization" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 25, Name = "职位设置", Identity = "set-pos", Type = ElementType.ButtonLink, AccessApi = "api/Organization/SetPosition" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 26, Name = "添加页面元素", Identity = "add-element", Type = ElementType.ButtonLink, AccessApi = "api/Element/CreateElement" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 27, Name = "导出", Identity = "export-element", Type = ElementType.ButtonLink, AccessApi = "api/Element/ExportElementData" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 28, Name = "编辑", Identity = "edit-element", Type = ElementType.ButtonLink, AccessApi = "api/Element/UpdateElement" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 29, Name = "删除元素", Identity = "remove-element", Type = ElementType.ButtonLink, AccessApi = "api/Element/DeleteElement" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 30, Name = "设定密码", Identity = "set-password", Type = ElementType.ButtonLink, AccessApi = "api/User/SetUserPassword" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 31, Name = "用户激活", Identity = "active-user", Type = ElementType.ButtonLink, AccessApi = "api/User/ActiveUser" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 32, Name = "页面", Identity = "user-page", Type = ElementType.ButtonLink, AccessApi = "api/Organization/GetOrganizationTree,api/Role/GetRoleDic,api/User/SearchUser,api/User/GetUser,api/Position/GetPositionDic" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 33, Name = "页面", Identity = "role-page", Type = ElementType.ButtonLink, AccessApi = "api/Role/GetRoles,api/Element/GetElementTree,api/Role/GetRole" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 35, Name = "页面", Identity = "org-page", Type = ElementType.ButtonLink, AccessApi = "api/Organization/GetOrganization,api/Organization/GetOrganizationTree,api/Organization/GetOrganizationTypes" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 36, Name = "页面", Identity = "right-page", Type = ElementType.ButtonLink, AccessApi = "api/ApiInfo/GetApiPaths,api/Element/GetElement,api/Element/GetElementTree" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 37, Name = "激活角色", Identity = "active-role", Type = ElementType.ButtonLink, AccessApi = "api/Role/ActiveRole" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 38, Name = "创建或编辑组织类型", Identity = "add-update-org-type", Type = ElementType.ButtonLink, AccessApi = "api/Organization/AddOrUpdateOrganizationType" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 39, Name = "删除组织类型", Identity = "remove-org-type", Type = ElementType.ButtonLink, AccessApi = "api/Organization/RemoveOrganizationType" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 40, Name = "职位信息", Identity = "position", Type = ElementType.Menu, AccessApi = "" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 41, Name = "页面", Identity = "position-page", Type = ElementType.ButtonLink, AccessApi = "api/Position/GetPositions,api/Position/GetPosition" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 42, Name = "添加", Identity = "add-position", Type = ElementType.ButtonLink, AccessApi = "api/Position/AddOrUpdatePosition" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 45, Name = "编辑 ", Identity = "edit-position", Type = ElementType.ButtonLink, AccessApi = "api/Position/AddOrUpdatePosition" });
            _dbContext.RbacElements.Add(new RbacElement { Id = 46, Name = "删除", Identity = "delete-position", Type = ElementType.ButtonLink, AccessApi = "api/Position/DeletePosition" });
